...
from .views import add_news_entry_ajax, create_news, delete_news, edit_news, login_user, logout_user, register, show_json, show_json_by_id, show_main, show_news, show_xml, show_xml_by_id
